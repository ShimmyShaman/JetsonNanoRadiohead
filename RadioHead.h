...
#define RH_PLATFORM_JETSON_NANO      20

#ifndef JETSON_NANO // TODO
#define JETSON_NANO
#endif // JETSON_NANO
...
// Select platform automatically, if possible
 ...
 #elif defined(JETSON_NANO)
  #define RH_PLATFORM RH_PLATFORM_JETSON_NANO
 #elif defined(__unix__) // Linux
  // #define RH_PLATFORM RH_PLATFORM_UNIX TODO
...
#elif (RH_PLATFORM == RH_PLATFORM_JETSON_NANO)
 #define RH_HAVE_HARDWARE_SPI
 #define RH_HAVE_SERIAL
 #define PROGMEM
// You can enable MUTEX to protect critical sections for multithreading						   
// #define RH_USE_MUTEX
 #include <RHutil/JetsonNano.h>
 #include <string.h>
 //Define SS for CS0 or pin 24
 #define SS 19
